    ...
    for i, data in enumerate(valid_loader):
        ...
        if savepath:
            ...
            if save_format == 'nii':
                ...
                newImg = sitk.GetImageFromArray(seg_img)
                sitk.WriteImage(newImg, oname)
                ...
                if snapshot:
                    ...
                    for frame in range(T):
                        ...
                        imageio.imsave(os.path.join(savepath, 'snapshot', name, str(frame) + '.png'),
                                       Snapshot_img[:, :, :, frame])
        ...
        if scoring:
            ...
            if snapshot:
                ...
                for frame in range(T):
                    ...
                    imageio.imsave(os.path.join('snapshot', cfg, name, str(frame) + '.png'),
                                   Snapshot_img[:, :, :, frame])
